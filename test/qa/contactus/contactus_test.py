...
def contact_us(driver):
    ...
    try:
        ...
        driver.find_element_by_xpath("//*[@id='shopify-section-header']/header[2]/div[2]/div/div[2]/div/div/ul/li[2]/a").click()
    except:
        assert 0, "contactus icon is not clickable"
    try:
        product_page = driver.find_element_by_xpath("//*[@id='shopify-section-header']/header[2]/div[2]/div/div[2]/div/div/ul/li[2]/a")
